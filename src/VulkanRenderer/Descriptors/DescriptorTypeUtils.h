...
namespace DescriptorTypeUtils
{
    ...
    void createUboPoolSize(const size_t size, VkDescriptorPoolSize& poolSize);

    void createDescriptorBufferInfo(const VkBuffer& uniformBuffer, VkDescriptorBufferInfo& bufferInfo);
    ...
    void createSamplerPoolSize(const size_t size, VkDescriptorPoolSize& poolSize);
