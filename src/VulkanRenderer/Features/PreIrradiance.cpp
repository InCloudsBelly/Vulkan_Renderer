...
) : m_logicalDevice(logicalDevice), m_dim(dim), m_format(VK_FORMAT_R32G32B32A32_SFLOAT)
{
...
template<typename T>
void PrefilteredIrradiance<T>::createTargetImage(const VkPhysicalDevice& physicalDevice)
{
...
template<typename T>
const Image& PrefilteredIrradiance<T>::get() const
{
