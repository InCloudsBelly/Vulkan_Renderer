...
void GraphicsPipelineManager::createShaderStagesInfos(const VkShaderModule& vertexShaderModule,const VkShaderModule& fragmentShaderModule,VkPipelineShaderStageCreateInfo(&shaderStagesInfos)[2])
{
    // - Vertex Shader
...
void GraphicsPipelineManager::createDynamicStatesInfo(const std::vector<VkDynamicState>& dynamicStates,VkPipelineDynamicStateCreateInfo& dynamicStatesInfo) 
{
...
void GraphicsPipelineManager::createViewport(VkViewport& viewport,const VkExtent2D& extent) 
{
    viewport.x = 0.0f;
    viewport.y = 0.0f;
...
void GraphicsPipelineManager::createScissor(VkRect2D& scissor,const VkExtent2D& extent) 
{
...
void GraphicsPipelineManager::createViewportStateInfo(VkPipelineViewportStateCreateInfo& viewportStateInfo)
{
...
void GraphicsPipelineManager::createRasterizerInfo(VkPipelineRasterizationStateCreateInfo& rasterizerInfo) 
{
...
void GraphicsPipelineManager::createMultisamplingInfo(VkPipelineMultisampleStateCreateInfo& multisamplingInfo) 
{
...
void GraphicsPipelineManager::createColorBlendingAttachment(VkPipelineColorBlendAttachmentState& colorBlendAttachment)
{
...
void GraphicsPipelineManager::createColorBlendingGlobalInfo(const VkPipelineColorBlendAttachmentState& colorBlendAttachment,VkPipelineColorBlendStateCreateInfo& colorBlendingInfo) 
{
...
void GraphicsPipelineManager::createPipelineLayout(const VkDevice& logicalDevice, const VkDescriptorSetLayout& descriptorSetLayout) 
{
...
void GraphicsPipelineManager::createGraphicsPipeline(const VkDevice& logicalDevice, const VkExtent2D& extent, const VkRenderPass& renderPass, const VkDescriptorSetLayout& descriptorSetLayout)
{
    // -------------------Shader Modules--------------------
...
void GraphicsPipelineManager::destroyPipelineLayout(const VkDevice& logicalDevice) 
{
