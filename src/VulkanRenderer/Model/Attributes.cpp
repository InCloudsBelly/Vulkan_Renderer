...
///////////////////////////////////////Deferred OFF//////////////////////////////
VkVertexInputBindingDescription Attributes::DEFERRED_OFF::getBindingDescription()
{
	VkVertexInputBindingDescription bindingDescription{};
	// Index of the binding in the array of bindings(to connect with the
	// attribute descriptions).
...
std::vector<VkVertexInputAttributeDescription> Attributes::DEFERRED_OFF::getAttributeDescriptions()
{
